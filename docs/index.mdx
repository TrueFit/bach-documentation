...
- [withAction](/bachredux#withaction)
- [withActions](/bachredux#withactions)
- [withDispatch](/bachredux#withdispatch)
- [withSelector](/bachredux#withselector)
- [withStore](/bachredux#withstore)

### @truefit/bach-recompose

- [mapProps](/bachrecompose#mapprops)
- [renameProp](/bachrecompose#renameprop)
- [renameProps](/bachrecompose#renameprops)
- [renderIf](/bachrecompose#renderif)
- [renderNothing](/bachrecompose#rendernothing)
- [withProps](/bachrecompose#withprops)
- [withHandlers](/bachrecompose#withhandlers)
- [withLifecycle](/bachrecompose#withlifecycle)
